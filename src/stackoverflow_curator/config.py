"""Configuration management for the Stack Overflow / HuggingFace RAG curator."""
...
class ProjectConfig(BaseModel):
    ...
    system_prompt: str = Field(
        default=(
            ...
            " HuggingFace Transformers based on the official documentation."
        ),
        description="System prompt for the RAG agent",
    )
